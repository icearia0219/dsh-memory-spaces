/** Self-contained Host and Web-client build used by local development and git installs. */
...
const PLUGIN_ID = 'dsh-memory-spaces'
...
const CSS_VIRTUAL_PREFIX = '\0dsh-memory-css:'
